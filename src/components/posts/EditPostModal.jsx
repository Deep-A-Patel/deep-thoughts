...
//                     <TextField id="datetime-local" label="Post Date:" type="datetime-local" InputLabelProps={{ shrink: true, }} />
...
//                 </DialogContent>
//                 <DialogActions>
//                     <Button color="secondary" variant="contained" onClick={this.editPosts}>SUBMIT</Button>
